...
export default {
  ...
  watch: {
    videoLists(newValue) {
      ...
      this.baiduMap.center.lat =
        newValue.length > 0 ? newValue[0].lat : "39.820";
      this.baiduMap.center.lng =
        newValue.length > 0 ? newValue[0].lng : "116.1";
    }
  },
  methods: {
    clickPoint(video) {
    ...
    handler() {
      this.baiduMap.center.lat =
        this.videoLists.length > 0 ? this.videoLists[0].lat : "39.820";
      this.baiduMap.center.lng =
        this.videoLists.length > 0 ? this.videoLists[0].lng : "116.1";
    }
  },
  mounted() {
