  ...
  <div>
    ...
    >
      ...
      <template v-for="(video, id) in videoLists">
        <bm-marker
          :position="{ lng: video.lng, lat: video.lat }"
          :key="id"
          :clicking="true"
          @click="clickPoint(video)"
      ...
      >
        <el-row :gutter="40">
          ...
          <el-col :span="12">
            <el-row>
              <el-col :span="12"
                ><div><i class="el-icon-user-solid"></i>姓名:</div></el-col
              >
              <el-col :span="12"
                ><div v-text="selectVideo.user.userName"></div
              ></el-col>
              <el-col :span="12"
                ><div><i class="el-icon-phone"></i>手机号:</div></el-col
              >
              <el-col :span="12"
                ><div v-text="selectVideo.userTel"></div
              ></el-col>
              <el-col :span="12"
                ><div><i class="el-icon-add-location"></i>经度:</div></el-col
              >
              <el-col :span="12"><div v-text="selectVideo.lat"></div></el-col>
              <el-col :span="12"
                ><div><i class="el-icon-add-location"></i>纬度:</div></el-col
              >
...
export default {
  ...
  methods: {
      ...
      setTimeout(() => {
        if (this.videoType == "1") {
          this.$message.success(
            "当前有" + this.videoLists.length + "个直播资源"
          );
        } else {
          this.$message.success(
            "当前有" + this.videoLists.length + "个录播资源"
          );
        }
      }, 500);
    ...
    initVideo(videoType) {
      var _this = this;
      getRequest("/web/videos/?flag=" + videoType).then(resp => {
